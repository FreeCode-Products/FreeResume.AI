      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-linear-to-tr from-[#ff68a7] to-[#1507df] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          />
        </div>
        <div className="mx-auto max-w-4xl py-20 sm:py-48 lg:py-32">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <CustomButton name={"Create my Resume"} containerClass="master"/>
              <CustomButton name={"Import your Resume"}  containerClass="masterlight"/>
            </div>
          </div>
        </div>
        <div
